...
import { mapInteractionPlugins } from '../../../src/plugins/mapInteractionPlugin.tsx';
...
// plugins MapViewer registers: the POI preview, the Back button of a nested map it opens, and
// the wheel/swipe POI tour.
export const plugins = [...poiPreviewPlugins, ...nestedMapPlugins, ...mapInteractionPlugins];
